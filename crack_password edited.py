...
def search_method_2(num_pass_wheels):
    ...
    wheel = " #÷/-_.ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"
...
def main(argv=None):
    ...
    if not foundit:
        print("Method 1 (5 digit) did not work!")
        if show_instructions:
            input("Press enter to continue.")
    ...
    if not foundit:
        print("Method 1 (6 digit) did not work!")
        if show_instructions:
            input("Press enter to continue.")
    ...
    if not foundit:
        print("Method 1 (7 digits) did not work!")
        if show_instructions:
            input("Press enter to continue.")
    ...
    if not foundit:
        ...
        foundit = search_method_2(1)
    # Still looking? Try 7 digit numbers
    if not foundit:
        print("Method 2 (1 digits) did not work!")
        if show_instructions:
            input("Press enter to continue.")

        foundit = search_method_2(2)
    # Still looking? Try 7 digit numbers
    if not foundit:
        print("Method 2 (2 digits) did not work!")
        if show_instructions:
            input("Press enter to continue.")

        foundit = search_method_2(3)
    # Still looking? Try 7 digit numbers
    if not foundit:
        print("Method 2 (3 digits) did not work!")
        if show_instructions:
            input("Press enter to continue.")
    ...
    # Still looking? Try 7 digit numbers
    if not foundit:
        print("Method 2 (4 digits) did not work!")
        if show_instructions:
            input("Press enter to continue.")

        foundit = search_method_2(5)
    # Still looking? Try 7 digit numbers
    if not foundit:
        print("Method 2 (5 digits) did not work!")
        if show_instructions:
            input("Press enter to continue.")
    ...
    # Still looking? Try 7 digit numbers
    if not foundit:
        print("Method 2 (8 digits) did not work!")
        if show_instructions:
            input("Press enter to continue.")

        foundit = search_method_2(9)
    # Still looking? Try 7 digit numbers
    if not foundit:
        print("Method 2 (9 digits) did not work!")
        if show_instructions:
            input("Press enter to continue.")

        foundit = search_method_2(10)
    # Still looking? Try 7 digit numbers
    if not foundit:
        print("Method 2 (10 digits) did not work!")
        if show_instructions:
            input("Press enter to continue.")

        foundit = search_method_2(11)
    # Still looking? Try 7 digit numbers
    if not foundit:
        print("Method 2 (11 digits) did not work!")
        if show_instructions:
            input("Press enter to continue.")
